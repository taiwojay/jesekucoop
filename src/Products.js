              ...
              <Card>
                ...
                <Accordion.Collapse eventKey="0">
                  <Card.Body variant='dark' className='card-content'>
                    This is a fixed and uniform amount paid by a member at the start of their membership. This account is opened alongside the normal savings account at your decision to be a member of Jeseku.
                  The Share Capital Savings secures your stake as a shareholder and member of the group
                  </Card.Body>
                </Accordion.Collapse>
              </Card>
              <Card>
            ...
            <h3 className='subtitle'>Loans <span><FontAwesomeIcon icon={faWallet}/></span> </h3>
             <Accordion>
              <Card className='bg-light-blue'>
                ...
                <Accordion.Collapse eventKey="0">
                  <Card.Body  className='card-content'>
                  This is a loan you have access to any time after 6 months of membership. You are eligible to borrow an addition of your share capital savings and Normal Savings multiplied by 2. You are expected to repay this loan between 10 to 12 months with an interest of 1.5% per month. You will need 2 members of your group or a friend of yours who is also a member of Jeseku to stand in for you as guarantors.
                  </Card.Body>
                </Accordion.Collapse>
              </Card>
              <Card>
                ...
                <Accordion.Collapse eventKey="1">
                  <Card.Body  className='card-content'>
                  This is a short-term loan expected to be repaid within 3 to 4 months with an interest of % per month.
